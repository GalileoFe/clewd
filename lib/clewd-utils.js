...
let randomInt, randomBytes, Version, Encoder, Main, Replacements, DangerChars, AI, indexOfH, indexOfA;
({randomInt, randomBytes} = require('node:crypto'));
({version: Version} = require('../package.json'));
Encoder = (new TextDecoder,
    new TextEncoder);
Main = 'clewd修改版 v' + Version + '(6) by tera';
Replacements = {
    user: 'Human',
    assistant: 'Assistant',
    system: '',
